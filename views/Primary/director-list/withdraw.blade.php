                    ...
                    <div class="col-sm-12">
                        <div class="element-box">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <form method="POST" action="{{ route('directorWithdraw.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="form-group row col-sm-12">
                                                <label for="withdraw" class="col-sm-4">Withdraw Amount</label>
                                                <div class="col-sm-8">
                                                    <input class="form-control" placeholder="Amount of withdraw" required
                                                        name="amount" type="number" id="withdraw">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group row col-sm-12">
                                                <label for="details" class="col-sm-4">Withdraw Details</label>
                                                <div class="col-sm-8">
