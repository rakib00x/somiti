                        ...
                        <div class="element-box" style="display: none" id="add_form">
                            <form method="POST" action="{{ route('fixed-diposit-scheme.store') }}" accept-charset="UTF-8" note="Are you sure? you want to add?">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 offset-4">
                                        <div class="form-group">
                                            <label for="name">{{__('Scheme Name')}}</label>
                                ...
                                <div class="row">
                                    <div class="col-sm-4 offset-4">
                                        <div class="form-group">
                                            <label for="type">{{__('Fixed Deposit Type')}}</label>
                                ...
                                <div class="row duration">
                                    <div class="col-sm-4 offset-4">
                                        <div class="form-group">
                                            <label for="duration">{{__('Fixed Deposit Duration (months)')}}</label>
                                ...
                                <div class="row">
                                    <div class="col-sm-4 offset-4">
                                        <div class="form-group">
                                            <label for="profit">{{__('Profit in percent')}}</label>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="element-wrapper">
                                <h6>{{__('Fixed Deposit Scheme List')}}
                            ...
                            <div class="element-box-tp">
                                ...
                                <table id="example" class="table table-striped table-borderless border border-secondary text-center">
                                    <thead class="table-dark">
                                        <tr role="row">
                                            <th class="">#</th>
                                            <th class="">{{__('Structure Name')}}</th>
                                            <th class="">{{__('Type')}}</th>
                                            <th class="">{{__('Duration')}}</th>
                                            <th class="">{{__('Profit')}}</th>
                                            <th class="">{{__('Note')}}</th>
