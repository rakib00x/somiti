    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="element-box" style="display: visible" id="add_form">
                <h3 class="card-header text-center py-4 bg-success rounded text-white text-uppercase">New Area</h3>
                    ...
                    <div class="row">
                        <div class="col-md-6 mx-auto mt-3">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Area Code" required name="area_code"
                                    type="text" id="area_code" value="{{ old('area_code') }}">
                            </div>
