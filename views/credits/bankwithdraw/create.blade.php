    ...
    <div class="content-w">
        <div class="content-i">
            <div class="content-box">
                <div class="row">
                    <div class="col-sm-12">
                        <form method="POST" action="{{route('bankwithdraw.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="element-box">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="details">Withdraw Details</label>
                                                    <textarea rows="1" class="form-control" placeholder="Notes of Withdraw" name="details" cols="50"
                                                        id="details"></textarea>
                                                </div>
                                            </div>
                                        </div>
