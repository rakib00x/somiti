                    ...
                    <div class="col-sm-12 px-0">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h4 class="alert alert-success">ডি পি এস একাউন্ট লিস্ট</h4>
                            </div>
                        </div>
                        <table class="table table-bordered table-sm">
                            <thead class="table-secondary data_table">
                                <tr class="align-middle text-center">
                                    ...
                                    <td class="p-0 text-center border border-dark align-middle" colspan="4">ডি পি এস</td>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                @foreach ($member->savings as $dps)
                                    <tr class="small text-center">
                                        <td class="p-0 border border-secondary">{{ $loop->iteration }}</td>
                                        <td class="p-0 border border-secondary">{{$dps->savings_amount}}</td>
                                        <td class="p-0 border border-secondary">{{$dps->installment}}</td>
                                        <td class="p-0 border border-secondary">{{$dps->savings_amount - $dps->installment}}</td>
                                        <td class="p-0 border border-secondary">{{$dps->balance}}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h4 class="alert alert-success">ডি পি এস ট্রানিজ্যাকশন লিস্ট</h4>
                            </div>
                        </div>
                        <table class="table table-bordered table-sm">
                            <thead class="table-secondary data_table">
                                <tr class="align-middle text-center">
                                    <td class="p-0 text-center border border-dark align-middle" rowspan="2">ক্রঃ নং</td>
                                    <td class="p-0 text-center border border-dark align-middle" colspan="7">ডি পি এস</td>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                @foreach ($savings as $saving)
                                    ...
                                    <tr class="small text-center">
                                        <td class="p-0 border border-secondary">{{ $loop->iteration }}</td>
                                        <td class="p-0 border border-secondary">{{$transaction->date}}</td>
                                        <td class="p-0 border border-secondary">{{$transaction->deposit}}</td>
                                        <td class="p-0 border border-secondary">{{$transaction->withdraw}}</td>
                                        <td class="p-0 border border-secondary">{{$saving->balance}}</td>
                                        <td class="p-0 border border-secondary">{{$transaction->profit}}</td>
                                        <td class="p-0 border border-secondary">{{$transaction->penalty}}</td>
                                        <td class="p-0 border border-secondary">{{$transaction->note}}</td>
                                    </tr>
                                    @endforeach
                                @endforeach
                            </tbody>
