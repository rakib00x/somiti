                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="element-box">
                            <form method="POST" action="k" accept-charset="UTF-8"
                                class="form-inline justify-content-center"><input name="_token" type="hidden"
                                    value="">
                                <div class="form-element control-rounded text-center">
                                    <label for="account" class="sr-only">Bank Accounts</label>
                                    <select class="form-control rounded" autofocus id="account" name="account">
                                        <option selected="selected" value="">All Bank Accounts</option>
                                        <option value="1">Duch Bangla Bank Limited</option>
                                        <option value="9">Noah Page</option>
                                    </select>
                                    <label for="branch_id" class="sr-only">Select branch</label>
