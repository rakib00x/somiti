...
@section('content')
    ...
    <head>
        <title>Performance Report | app name</title>
        <meta charset="utf-8">
                                        ...
                                        <table class="table table-striped table-lightfont dataTable" role="grid"
                                            ...
                                            <thead>
                                                <tr class="text-center">
                                                    ...
                                                    <th style="font-weight: bold">GL Savings</th>
                                                    <th style="font-weight: bold">DPS</th>
                                                    <th style="font-weight: bold">Investment</th>
                                                    <th style="font-weight: bold">Share</th>
                                                    <th style="font-weight: bold">Fixed Deposit</th>
                                                    <th style="font-weight: bold">CC Loan</th>
                                            ...
                                            <tfoot class="text-right">
                                                <tr style="font-weight: bold">
                                                    <td colspan="6" class="text-right" style="font-weight: bold">Grand
                                                        Total</td>
