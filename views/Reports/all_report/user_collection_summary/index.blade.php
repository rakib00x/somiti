...
@section('content')
    ...
    <head>
        <title>User Collection Summary | app name</title>
        <meta charset="utf-8">
                                ...
                                <div class="col-sm-12">
                                    <div class="element-box">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <h6 class="element-header text-right">
                                            ...
                                            <table class="table table-bordered table-sm">
                                                <thead style="font-size: 10px;">
                                                    <tr>
                                                        ...
                                                        <td class="text-center">DPS</td>
                                                        <td class="text-center">Penalty</td>
                                                        <td class="text-center">Investment</td>
                                                        <td class="text-center">Penalty</td>
                                                        <td class="text-center">Share</td>
                                                        <td class="text-center">Fixed Deposit</td>
                                                        <td class="text-center">CC Loan</td>
                                                        <td class="text-center">CCMBR</td>
                                                        <td class="text-center">Penalty</td>
                                                        <td class="text-center">Admission</td>
                                                        <td class="text-center">Passbook</td>
                                                        <td class="text-center">Form</td>
                                                        <td class="text-center">Other Fee</td>
                                                        <td class="text-center">G.S Closing</td>
                                                        <td class="text-center">Loan Fee</td>
                                                        <td class="text-center">Stamp</td>

                                                        <td class="text-center">CC Stamp</td>
                                                        <td class="text-center">Risk</td>
                                                        <td class="text-center">Insurance</td>
                                                        <td class="text-center">Other</td>
                                                        <td class="text-center">M.S Fee</td>
