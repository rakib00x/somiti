                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <h6 class="element-header text-left">
                                                    Date wise user collection Summery
                                                </h6>
                                            </div>
                                            <div class="col-sm-6">
                                                <h6 class="element-header text-right">
                                                    Report For <u>All Staff:</u>
                                            ...
                                            <table class="table table-bordered table-sm">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">GL Savings</td>
                                                        <td class="text-center">Monthly Savings </td>
                                                        <td class="text-center">Penalty</td>
                                                        <td class="text-center">Investment</td>
                                                        <td class="text-center">Penalty</td>
                                                        <td class="text-center">Share </td>
                                                        <td class="text-center">CC Instalment</td>
                                                        <td class="text-center">Admission Fee</td>
                                                        <td class="text-center">Admission Form Fee</td>
                                                        <td class="text-center">Penalty</td>
