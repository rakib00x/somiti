                            ...
                            <tbody>
                                {{-- @foreach ($date as $data)
                                    <tr class="small text-center">
                                        <td class="p-0 border border-secondary">{{$data->m_name}}</td>
                                        <td class="p-0 border border-secondary">{{$data->account}}</td> --}}
                                        {{-- <td class="p-0 border border-secondary">{{$data->currentAccount->sum('deposit_amount')}}</td> --}}
                                        {{-- <td class="p-0 border border-secondary">{{$data->currentAccount->sum('withdraw')}}</td> --}}
                                    {{-- </tr>
                                @endforeach --}}
                            </tbody>
                        </table>
