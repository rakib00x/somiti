    ...
    <div class="content-w">
        <div class="content-i">
            <div class="content-box">
                <div class="row">
                    <div class="col-sm-12">
                        <h6 class="element-header text-center">New Return Out Loan</h6>
                        <div class="element-box">
                            <div class="row">
                                <div class="col-sm-3"></div>
                                <div class="col-sm-6">
                                    <form method="POST" action="{{ route('returntoutloan.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="form-group row col-sm-12">
                                                <label for="deposit" class="col-sm-4">Return OutLoan Amount</label>
                                                <div class="col-sm-8">
                                                    <input class="form-control" id="deposit_amount"
                                                        placeholder="Amount of Withdraw" required name="amount"
                                                        type="number">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group row col-sm-12">
                                                <label for="details" class="col-sm-4">Return OutLoan Details</label>
                                                <div class="col-sm-8">
                                                    <textarea rows="1" class="form-control" placeholder="Details" name="details" cols="50"
                                                        id="details"></textarea>
                                                </div>
                                            </div>
                                        </div>
