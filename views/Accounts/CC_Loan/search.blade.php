    ...
    <div class="content-w">
        <div class="content-i">
            <div class="content-box">
                <div class="row">
                    <div class="col-sm-12">
                        <h6 class="element-header text-center">{{__('Member Search for New CC Loan')}}</h6>
                        <div class="element-box">
                            <form method="POST" action="{{ route('cc_loan.search') }}" accept-charset="UTF-8" class="form-inline justify-content-center">
