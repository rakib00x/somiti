...
<div class="content-w">
    <div class="content-i">
        <div class="content-box">
            <div class="row">
                <div class="col-sm-12">
                    <h6 class="element-header text-center">Member Search for CC Loan Closing</h6>
                    <div class="element-box">
                        <form method="POST" action="{{route('cc_closing.search')}}" accept-charset="UTF-8" class="form-inline justify-content-center"> @csrf
