@extends('layouts.frontend.app', ['pageTitle' => 'Bank Deposit'])
                            ...
                            <div class="element-box-tp" id="printArea">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-center">
                                        ...
                                        <h1 class="mb-0 bangla_font2">ডিপোজিট লিস্ট</h1>
                                ...
                                <div class="text-center d-print-none" >
                                    <a href="{{ route('bank.deposit') }}" class="btn btn-success">{{__('Add New Deposit')}}</a>
                                </div>
